...
public class ExercicioCriacaoMetodos {
...
{ System.out.println("Somar " + (numeroUm + numeroDois));}
{ System.out.println("Multiplicar " + (numeroUm * numeroDois));}
{ System.out.println("Subtrair " + (numeroDois - numeroUm));}
{ System.out.println("Dividir " + (numeroDois / numeroUm));}
